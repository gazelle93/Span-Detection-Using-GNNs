...
def main(args):
    ...
    if args.gnn.lower() == "depgcn":
        model = Dependency_GCN(input_dim=input_dim, hidden_dim=hidden_dim, output_dim=output_dim, dependency_list=dependency_list, num_layers=args.num_layers, dropout_rate=args.dropout_rate, reverse_case=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gnn", default="depgat", type=str, help="Type of dependency gnn layer. (depgcn, depgat)")
